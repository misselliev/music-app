...
a8 = Album.create(cover: "https://static.stereogum.com/uploads/2018/11/1975-1542916031-compressed.png", title: "A Brief Inquiry Into Online Relationships", artist: "The 1975")
Track.create(name: "The 1975", minutes: 5, album_id: a8.id)
Track.create(name: "Give yourself a try", minutes: 6, album_id: a8.id)
Track.create(name: "TOOTIMETOOTIMETOOTIME", minutes: 10, album_id: a8.id)
Track.create(name: "How to draw/Petrichor", minutes: 4, album_id: a8.id)
Track.create(name: "Love it if we made it", minutes: 6, album_id: a8.id)
Track.create(name: "Be my mistake", minutes: 6, album_id: a8.id)
Track.create(name: "Sincerity is scary", minutes: 9, album_id: a8.id)
Track.create(name: "I like America and America likes me", minutes: 9, album_id: a8.id)
Track.create(name: "The man who married a robot", minutes: 7, album_id: a8.id)
Track.create(name: "Inside your mind", minutes: 5, album_id: a8.id)
Track.create(name: "It's not living (if it's not with you)", minutes: 6, album_id: a8.id)
Track.create(name: "Surrounded by heads and bodies", minutes: 5, album_id: a8.id)
Track.create(name: "Mine", minutes: 5, album_id: a8.id)
Track.create(name: "I couldn't be more in love", minutes: 7, album_id: a8.id)
Track.create(name: "I always wanna die (sometimes)", minutes: 9, album_id: a8.id)
